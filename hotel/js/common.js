$(document).ready(function(){
	...
	if ($(window).width() > 950) {
		...
		$("#video_wrap").append( "<audio src='audio/audio.mp3' autoplay loop></audio><video autoplay= 'true' loop='true' muted class='fillWidth fadeIn animated' id='video-background'><source src='video/Mallorca.mp4' type='video/mp4'></video>" )
